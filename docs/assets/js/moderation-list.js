        ...
        },
        {
          ...
          template: function () {
            return `
              ...
              <a href="javascript:;" class="btn btn-sm btn-clean btn-outline-success btn-icon mr-2" data-toggle="tooltip" data-placement="left" title="Publish item"><i class="la la-power-off"></i></a>
              <a href="javascript:;" class="btn btn-sm btn-clean btn-outline-danger btn-icon" data-toggle="tooltip" data-placement="left" title="Delete item"><i class="la la-trash-alt"></i></a>
            `;
          },
        },
      ],
